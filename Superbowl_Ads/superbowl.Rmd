...
```{r}
#save plots
ggsave(filename = "images/brand_means.png", plot = brand_plot, width = 10, height = 10)
ggsave(filename = "images/brand_like.png", plot = brand_plot, width = 10, height = 10)
ggsave(filename = "images/brand_dislike.png", plot = brand_plot, width = 10, height = 10)
ggsave(filename = "images/brand_comment.png", plot = brand_plot, width = 10, height = 10)
